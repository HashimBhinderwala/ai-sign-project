...
import {Inject} from '@angular/core'; // <-- This is now injected with `inject()`
...
export class AppComponent implements AfterViewInit {
  ...
  // ADDED - Inject PLATFORM_ID to check the environment
  ...
  initCookieConsent() {
    // This function uses `location`, which only exists in the browser
    return CookieConsent.run({
      ...
      cookie: {
        name: 'cc_cookie',
        domain: location.hostname, // This is the problematic line
        path: '/',
        sameSite: 'Lax',
